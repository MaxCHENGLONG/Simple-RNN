...
def train():
    ...
    seq_len = 25        # length of RNN sequence
    num_layers = 3      # num of layers in RNN layer stack
    lr = 0.0001         # learning rate
    grad_clip = 1.0     # max gradient norm for stable RNN training
    ...
    save_path = "./preTrained/CharRNN_shakespeare_Chenglong.pth"
    ...
    for i_epoch in range(1, epochs+1):
        ...
        input_seq = data[rand_index : rand_index+1].clone()
